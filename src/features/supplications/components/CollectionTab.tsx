...
interface CollectionTabProps {
  ...
  onOpenSubcategory: (subcategory: DuaSubcategory) => void;
}
...
export default function CollectionTab({ manuscriptColors, bookmarkedDuas, onRemoveBookmark, onOpenSubcategory }: CollectionTabProps) {
  return (
        ...
        {bookmarkedDuas.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={[styles.emptyStateText, { color: manuscriptColors.lightInk }]}>
              Bookmark your favorite duas to access them quickly here
            </Text>
          </View>
        ) : (
